...
historical_specification <- data.frame(
  ...
  path = c(
    here::here("UK_analysis", "UK_results", "UK_result_under_65.rda"),
    here::here("UK_analysis", "UK_results", "UK_result_65_85.rda"),
    here::here("UK_analysis", "UK_results", "UK_result_85.rda"),
    here::here("ireland_analysis", "IE_result", "IE_result_age_25_45.rda"),
    here::here("ireland_analysis", "IE_result", "IE_result_age_45_65.rda"),
    here::here("ireland_analysis", "IE_result", "IE_result_age_65_85.rda"),
    here::here("ireland_analysis", "IE_result", "IE_result_age_85.rda")
  ),
  object_name = c(
    rep("model_result", 3L),
    "model_result_25_45",
